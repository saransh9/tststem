...
public class User
{
    ...
    {
        return "ClassPojo [location = "+location+", portfolio_url = "+portfolio_url+", profile_image = "+profile_image+", links = "+links+", total_photos = "+total_photos+", total_likes = "+total_likes+", id = "+id+", first_name = "+first_name+", instagram_username = "+instagram_username+", username = "+username+", updated_at = "+updated_at+", bio = "+bio+", name = "+name+", total_collections = "+total_collections+", last_name = "+last_name+", twitter_username = "+twitter_username+"]";
    }
}
